...
<html lang="en">
  <head>
    ...
    <title>Online Marriage Registration System || All Marriage Application</title>
...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">Toda la solicitud de matrimonio</h5>
    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Toda la solicitud de matrimonio</h6>
